...
const resources = {
  en: {
    translation: {
      ...
      petSitter: {
        headers: { profile: 'My Profile', profileSubtitle: 'Care, services and availability', supportTickets: 'Support Tickets', supportTicketsSubtitle: 'Secure support requests', newTicket: 'New Support Ticket', newTicketSubtitle: 'We are here to help', ticket: 'Support Ticket', ticketSubtitle: 'Secure conversation', notifications: 'Notifications', notificationsSubtitle: 'Your latest updates', changePassword: 'Change Password', changePasswordSubtitle: 'Secure your account' },
        tabs: { dashboard: 'Dashboard', dashboardSubtitle: 'Pet care at a glance', chats: 'Chats', chatsSubtitle: 'Pet Owner conversations', more: 'More', moreSubtitle: 'Profile and settings' },
        dashboard: { eyebrow: 'PET SITTER DASHBOARD', hello: 'Hello, {{name}}', subtitle: 'Keep your care profile current and stay connected with pet owners.', petTypes: 'Pet types', services: 'Services', unreadChats: 'Unread chats', supportReplies: 'Support replies', quickActions: 'Quick actions', editProfile: 'Edit profile', editProfileText: 'Update your experience and services', chats: 'Pet Owner chats', chatsText: 'View conversations and attachments', support: 'Support tickets', supportText: 'Get help and track replies' },
        more: { careProfile: 'CARE PROFILE', supportSettings: 'SUPPORT & SETTINGS', profile: 'My profile', profileText: 'Personal details, services and availability', availability: 'Availability & pet types', availabilityText: 'Update the pets and care services you offer', support: 'Support tickets', supportText: 'Get help and track replies', notifications: 'Notifications', notificationsText: 'Updates from MyPetPlus', language: 'Language', changePassword: 'Change password', changePasswordText: 'Secure your account', account: 'Pet Sitter account', role: 'Pet Sitter', logout: 'Log out' },
        chats: { emptyTitle: 'No Pet Owner chats yet', emptyText: 'When a Pet Owner contacts you from your public profile, the conversation will appear here.', petOwner: 'Pet Owner', start: 'Start a conversation' },
        profile: { title: 'Your Pet Sitter Profile', subtitle: 'This information is shared with Pet Owners and synchronized with the website.', changePhoto: 'Change photo', uploading: 'Uploading…', fullName: 'Full name *', phone: 'Phone number', city: 'City', state: 'State / province', country: 'Country', address: 'Address', careExperience: 'Care experience', experienceYears: 'Years of experience', availability: 'Availability', availabilityPlaceholder: 'Mon–Fri, 09:00–18:00', about: 'About you', relevantExperience: 'Relevant experience', certifications: 'Certifications', certificationsHint: 'Separate with commas', petTypes: 'Pets you can handle *', services: 'Services you offer *', accepting: 'Available for new requests', unavailable: 'Not currently available', availabilityHint: 'Control whether your profile appears in Pet Owner search.', addDocuments: 'Add supporting documents', documentsHint: 'Upload certifications or verification documents (up to 5).', save: 'Save profile', uploadPhotoError: 'Unable to upload photo', uploadDocumentsError: 'Unable to upload documents', documentsUploaded: 'Documents uploaded', required: 'Add your name, at least one pet type, and one service.', saved: 'Pet Sitter profile saved', saveError: 'Unable to save profile' },
        directory: { title: 'Find Pet Sitters', subtitle: 'Trusted care, matched to the pets you love.', search: 'Search sitter or city', allPets: 'All pets', noSitters: 'No available Pet Sitters yet', noSittersText: 'Try another search or pet type. New verified sitters appear here automatically.', location: 'Location not listed', experience: '{{count}} years’ experience', petCare: 'Pet care' },
        details: { title: 'Pet Sitter Details', subtitle: 'Care profile and availability', verified: 'Verified Pet Sitter', experience: 'Years’ experience', services: 'Care services', unavailable: 'Unavailable', available: 'Available', about: 'About', noBio: 'This Pet Sitter has not added an introduction yet.', pets: 'Pets they can handle', availability: 'Availability', availabilityText: 'Contact the sitter to discuss their current availability.', generalAvailability: 'General availability: {{time}}', startChat: 'Start chat', chatError: 'Unable to start chat', notFound: 'Pet Sitter profile could not be found.' },
        registration: { eyebrow: 'PET SITTER NETWORK', title: 'Become a Pet Sitter', subtitle: 'Step 1 of 4 · Create your account. We will verify your email before collecting your care profile.', photo: 'Profile photo', fullName: 'Full name *', email: 'Email address *', phone: 'Phone number *', phoneHelper: 'Choose your country so your number is stored in international format.', dateOfBirth: 'Date of birth', chooseDate: 'Choose date', gender: 'Gender', selectGender: 'Select gender', address: 'Address', city: 'City', province: 'Province / state', country: 'Country / region', password: 'Password *', confirmPassword: 'Confirm password *', continue: 'Continue to email verification', alreadyRegistered: 'Already registered? Sign in', selectGenderTitle: 'Select gender', male: 'Male', female: 'Female', other: 'Other', preferNot: 'Prefer not to say', cancel: 'Cancel', photoError: 'Unable to select profile photo', requiredError: 'Complete the required details and add a profile photo.', emailError: 'Enter a valid email address.', phoneError: 'Use a valid phone number with a country code.', passwordError: 'Passwords must match and contain at least 6 characters.', createError: 'Unable to create your account', retryDetails: 'Please check your details and try again.' },
        onboarding: { eyebrow: 'PET SITTER NETWORK', experienceTitle: 'Your care experience', servicesTitle: 'Pets and services', experienceSubtitle: 'Step 3 of 4 · Add the information pet owners need before contacting you.', servicesSubtitle: 'Step 4 of 4 · Tell pet owners which animals and care services you offer.', emailVerified: 'Email verified', emailVerifiedText: 'Your account is active. Finish these last two profile steps to appear in Pet Owner search.', experienceYears: 'Experience (years)', experiencePlaceholder: '4', availability: 'Typical availability', availabilityPlaceholder: 'Weekdays, 09:00–18:00', bio: 'Short bio', experience: 'Pet-sitting experience', certifications: 'Certifications', certificationsHint: 'Separate multiple certifications with commas', documents: 'Related documents (optional)', continue: 'Continue to pets and services', petTypes: 'Pets you can handle *', services: 'Services you offer *', accepting: 'Accepting Pet Owner requests', unavailable: 'Not accepting requests right now', availabilityHint: 'You can update this anytime from your profile.', back: 'Back', finish: 'Finish setup', required: 'Select at least one pet type and one service.', complete: 'Your Pet Sitter profile is ready', saveError: 'Unable to save your care profile' },
        options: { DOG: 'Dog', CAT: 'Cat', BIRD: 'Bird', RABBIT: 'Rabbit', SMALL_PETS: 'Small pets', REPTILE: 'Reptile', FISH: 'Fish', OTHER: 'Other', DOG_SITTING: 'Dog sitting', CAT_SITTING: 'Cat sitting', HOME_BOARDING: 'Home boarding', HOME_VISITS: 'Home visits', DOG_WALKING: 'Dog walking', MEDICATION_ADMINISTRATION: 'Medication administration', PET_TAXI: 'Pet taxi' },
        support: {
          title: 'Support Tickets', subtitle: 'Keep every request, reply and document in one secure place.', new: 'New', search: 'Search tickets', status: 'STATUS', category: 'ISSUE TYPE', allStatuses: 'All statuses', allCategories: 'All categories', emptyTitle: 'No support tickets', emptyText: 'Need a hand with your account or a Pet Owner chat? Create a support ticket.', request: 'Support request', priority: 'priority', updated: 'Updated', createTitle: 'Create a Support Ticket', createText: 'Our team will keep all messages and supporting documents within this ticket.', subject: 'Subject', subjectPlaceholder: 'Briefly describe the issue', description: 'Description', descriptionPlaceholder: 'Tell us what happened and what would help us investigate.', attachments: 'Add attachments', attachmentsHint: 'Screenshots, PDFs or documents · up to 5 files', submit: 'Submit ticket', fileLimit: 'Attach up to 5 files, each no larger than 25 MB.', attachmentError: 'Unable to add attachment', validation: 'Add a clear subject and a description of at least 10 characters.', created: 'Ticket {{ticket}} created', createError: 'Unable to create ticket',
          labels: { OPEN: 'Open', IN_PROGRESS: 'In Progress', WAITING_FOR_PATIENT: 'Waiting for Pet Owner', RESOLVED: 'Resolved', CLOSED: 'Closed', LOW: 'Low', MEDIUM: 'Medium', HIGH: 'High', URGENT: 'Urgent', APPOINTMENT: 'Appointment issue', RESCHEDULE: 'Reschedule issue', VIDEO_CALL: 'Video call issue', PAYMENT: 'Payment issue', PHARMACY_ORDER: 'Pharmacy order issue', PARAPHARMACY_ORDER: 'Parapharmacy order issue', DELIVERY: 'Delivery issue', REFUND: 'Refund issue', PRESCRIPTION: 'Prescription issue', ACCOUNT_REGISTRATION: 'Account / registration issue', PET_PROFILE: 'Pet profile issue', VETERINARIAN: 'Doctor / veterinarian issue', TECHNICAL: 'Technical issue', OTHER: 'Other' },
        },
      },
    },
  },
  it: {
    translation: {
      ...
      petSitter: {
        headers: { profile: 'Il mio profilo', profileSubtitle: 'Cura, servizi e disponibilità', supportTickets: 'Ticket di assistenza', supportTicketsSubtitle: 'Richieste di assistenza sicure', newTicket: 'Nuovo ticket di assistenza', newTicketSubtitle: 'Siamo qui per aiutarti', ticket: 'Ticket di assistenza', ticketSubtitle: 'Conversazione sicura', notifications: 'Notifiche', notificationsSubtitle: 'I tuoi ultimi aggiornamenti', changePassword: 'Cambia password', changePasswordSubtitle: 'Proteggi il tuo account' },
        tabs: { dashboard: 'Dashboard', dashboardSubtitle: 'Panoramica della cura degli animali', chats: 'Chat', chatsSubtitle: 'Conversazioni con i proprietari', more: 'Altro', moreSubtitle: 'Profilo e impostazioni' },
        dashboard: { eyebrow: 'DASHBOARD PET SITTER', hello: 'Ciao, {{name}}', subtitle: 'Mantieni aggiornato il tuo profilo di cura e resta in contatto con i proprietari.', petTypes: 'Tipi di animali', services: 'Servizi', unreadChats: 'Chat non lette', supportReplies: 'Risposte assistenza', quickActions: 'Azioni rapide', editProfile: 'Modifica profilo', editProfileText: 'Aggiorna esperienza e servizi', chats: 'Chat con proprietari', chatsText: 'Visualizza conversazioni e allegati', support: 'Ticket di assistenza', supportText: 'Ricevi aiuto e segui le risposte' },
        more: { careProfile: 'PROFILO DI CURA', supportSettings: 'ASSISTENZA E IMPOSTAZIONI', profile: 'Il mio profilo', profileText: 'Dati personali, servizi e disponibilità', availability: 'Disponibilità e tipi di animali', availabilityText: 'Aggiorna gli animali e i servizi offerti', support: 'Ticket di assistenza', supportText: 'Ricevi aiuto e segui le risposte', notifications: 'Notifiche', notificationsText: 'Aggiornamenti da MyPetPlus', language: 'Lingua', changePassword: 'Cambia password', changePasswordText: 'Proteggi il tuo account', account: 'Account Pet Sitter', role: 'Pet Sitter', logout: 'Disconnetti' },
        chats: { emptyTitle: 'Nessuna chat con proprietari', emptyText: 'Quando un proprietario ti contatta dal tuo profilo pubblico, la conversazione apparirà qui.', petOwner: 'Proprietario', start: 'Avvia una conversazione' },
        profile: { title: 'Il tuo profilo Pet Sitter', subtitle: 'Queste informazioni sono condivise con i proprietari e sincronizzate con il sito web.', changePhoto: 'Cambia foto', uploading: 'Caricamento…', fullName: 'Nome completo *', phone: 'Numero di telefono', city: 'Città', state: 'Provincia / regione', country: 'Paese', address: 'Indirizzo', careExperience: 'Esperienza di cura', experienceYears: 'Anni di esperienza', availability: 'Disponibilità', availabilityPlaceholder: 'Lun–Ven, 09:00–18:00', about: 'Presentazione', relevantExperience: 'Esperienza rilevante', certifications: 'Certificazioni', certificationsHint: 'Separa con virgole', petTypes: 'Animali che puoi gestire *', services: 'Servizi offerti *', accepting: 'Disponibile per nuove richieste', unavailable: 'Non disponibile al momento', availabilityHint: 'Controlla se il tuo profilo appare nella ricerca dei proprietari.', addDocuments: 'Aggiungi documenti di supporto', documentsHint: 'Carica certificazioni o documenti di verifica (fino a 5).', save: 'Salva profilo', uploadPhotoError: 'Impossibile caricare la foto', uploadDocumentsError: 'Impossibile caricare i documenti', documentsUploaded: 'Documenti caricati', required: 'Inserisci il tuo nome, almeno un tipo di animale e un servizio.', saved: 'Profilo Pet Sitter salvato', saveError: 'Impossibile salvare il profilo' },
        directory: { title: 'Trova Pet Sitter', subtitle: 'Cura affidabile, su misura per gli animali che ami.', search: 'Cerca Pet Sitter o città', allPets: 'Tutti gli animali', noSitters: 'Nessun Pet Sitter disponibile', noSittersText: 'Prova un’altra ricerca o tipo di animale. I nuovi Pet Sitter verificati appariranno qui automaticamente.', location: 'Posizione non indicata', experience: '{{count}} anni di esperienza', petCare: 'Cura degli animali' },
        details: { title: 'Dettagli Pet Sitter', subtitle: 'Profilo di cura e disponibilità', verified: 'Pet Sitter verificato', experience: 'Anni di esperienza', services: 'Servizi di cura', unavailable: 'Non disponibile', available: 'Disponibile', about: 'Informazioni', noBio: 'Questo Pet Sitter non ha ancora aggiunto una presentazione.', pets: 'Animali che può gestire', availability: 'Disponibilità', availabilityText: 'Contatta il Pet Sitter per conoscere la disponibilità attuale.', generalAvailability: 'Disponibilità generale: {{time}}', startChat: 'Avvia chat', chatError: 'Impossibile avviare la chat', notFound: 'Profilo Pet Sitter non trovato.' },
        registration: { eyebrow: 'RETE PET SITTER', title: 'Diventa un Pet Sitter', subtitle: 'Passaggio 1 di 4 · Crea il tuo account. Verificheremo prima la tua email.', photo: 'Foto profilo', fullName: 'Nome completo *', email: 'Indirizzo email *', phone: 'Numero di telefono *', phoneHelper: 'Scegli il Paese così il numero verrà salvato in formato internazionale.', dateOfBirth: 'Data di nascita', chooseDate: 'Scegli data', gender: 'Genere', selectGender: 'Seleziona', address: 'Indirizzo', city: 'Città', province: 'Provincia / regione', country: 'Paese / regione', password: 'Password *', confirmPassword: 'Conferma password *', continue: 'Continua alla verifica email', alreadyRegistered: 'Hai già un account? Accedi', selectGenderTitle: 'Seleziona genere', male: 'Maschile', female: 'Femminile', other: 'Altro', preferNot: 'Preferisco non indicarlo', cancel: 'Annulla', photoError: 'Impossibile selezionare la foto profilo', requiredError: 'Completa i dati obbligatori e aggiungi una foto profilo.', emailError: 'Inserisci un indirizzo email valido.', phoneError: 'Usa un numero di telefono valido con prefisso internazionale.', passwordError: 'Le password devono coincidere e contenere almeno 6 caratteri.', createError: 'Impossibile creare l’account', retryDetails: 'Controlla i dati e riprova.' },
        onboarding: { eyebrow: 'RETE PET SITTER', experienceTitle: 'La tua esperienza di cura', servicesTitle: 'Animali e servizi', experienceSubtitle: 'Passaggio 3 di 4 · Aggiungi le informazioni che i proprietari devono conoscere.', servicesSubtitle: 'Passaggio 4 di 4 · Indica quali animali e servizi offri.', emailVerified: 'Email verificata', emailVerifiedText: 'Il tuo account è attivo. Completa gli ultimi passaggi per apparire nella ricerca dei proprietari.', experienceYears: 'Esperienza (anni)', experiencePlaceholder: '4', availability: 'Disponibilità abituale', availabilityPlaceholder: 'Giorni feriali, 09:00–18:00', bio: 'Breve presentazione', experience: 'Esperienza come Pet Sitter', certifications: 'Certificazioni', certificationsHint: 'Separa più certificazioni con virgole', documents: 'Documenti correlati (facoltativo)', continue: 'Continua a animali e servizi', petTypes: 'Animali che puoi gestire *', services: 'Servizi offerti *', accepting: 'Accetto richieste dai proprietari', unavailable: 'Non accetto richieste al momento', availabilityHint: 'Puoi aggiornarlo in qualsiasi momento dal tuo profilo.', back: 'Indietro', finish: 'Completa configurazione', required: 'Seleziona almeno un tipo di animale e un servizio.', complete: 'Il tuo profilo Pet Sitter è pronto', saveError: 'Impossibile salvare il profilo di cura' },
        options: { DOG: 'Cane', CAT: 'Gatto', BIRD: 'Uccello', RABBIT: 'Coniglio', SMALL_PETS: 'Piccoli animali', REPTILE: 'Rettile', FISH: 'Pesce', OTHER: 'Altro', DOG_SITTING: 'Dog sitting', CAT_SITTING: 'Cat sitting', HOME_BOARDING: 'Ospitalità a casa', HOME_VISITS: 'Visite a domicilio', DOG_WALKING: 'Passeggiate', MEDICATION_ADMINISTRATION: 'Somministrazione farmaci', PET_TAXI: 'Pet taxi' },
        support: {
          title: 'Ticket di assistenza', subtitle: 'Conserva ogni richiesta, risposta e documento in un unico luogo sicuro.', new: 'Nuovo', search: 'Cerca ticket', status: 'STATO', category: 'TIPO DI PROBLEMA', allStatuses: 'Tutti gli stati', allCategories: 'Tutte le categorie', emptyTitle: 'Nessun ticket di assistenza', emptyText: 'Hai bisogno di aiuto con il tuo account o una chat con un proprietario? Crea un ticket di assistenza.', request: 'Richiesta di assistenza', priority: 'priorità', updated: 'Aggiornato', createTitle: 'Crea un ticket di assistenza', createText: 'Il nostro team conserverà tutti i messaggi e documenti di supporto in questo ticket.', subject: 'Oggetto', subjectPlaceholder: 'Descrivi brevemente il problema', description: 'Descrizione', descriptionPlaceholder: 'Spiega cosa è successo e cosa ci aiuta a verificare.', attachments: 'Aggiungi allegati', attachmentsHint: 'Screenshot, PDF o documenti · fino a 5 file', submit: 'Invia ticket', fileLimit: 'Allega fino a 5 file, massimo 25 MB ciascuno.', attachmentError: 'Impossibile aggiungere l’allegato', validation: 'Aggiungi un oggetto chiaro e una descrizione di almeno 10 caratteri.', created: 'Ticket {{ticket}} creato', createError: 'Impossibile creare il ticket',
          labels: { OPEN: 'Aperto', IN_PROGRESS: 'In lavorazione', WAITING_FOR_PATIENT: 'In attesa del proprietario', RESOLVED: 'Risolto', CLOSED: 'Chiuso', LOW: 'Bassa', MEDIUM: 'Media', HIGH: 'Alta', URGENT: 'Urgente', APPOINTMENT: 'Problema appuntamento', RESCHEDULE: 'Problema di riprogrammazione', VIDEO_CALL: 'Problema videochiamata', PAYMENT: 'Problema pagamento', PHARMACY_ORDER: 'Problema ordine farmacia', PARAPHARMACY_ORDER: 'Problema ordine parafarmacia', DELIVERY: 'Problema consegna', REFUND: 'Problema rimborso', PRESCRIPTION: 'Problema prescrizione', ACCOUNT_REGISTRATION: 'Problema account / registrazione', PET_PROFILE: 'Problema profilo animale', VETERINARIAN: 'Problema veterinario', TECHNICAL: 'Problema tecnico', OTHER: 'Altro' },
        },
      },
    },
  },
